...
看完我參考網站後想說不要用他那個方法看看還有沒有其他辦法，所以就照著自己的方式打看看。這邊打完讓他run了之後發現他甚麼也沒跑出來，我也看不太懂這是甚麼問題，不知道到底是在merge之後沒有把待排序數字位子放對還是有少打了甚麼，所以想說看要不要換其他的方法試看看
...
class之後不知道為什麼就沒有辦法執行了，不知道是不是因為我merge了兩次還是怎麼樣，但感覺很無解，所以還是直接改改看，看有沒有其他的方法可以用
